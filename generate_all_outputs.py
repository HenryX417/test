...
def run_part1_basic_scenarios(output_dir):
    ...
    print_subsection('Running simulations for Scenarios 1-4')
    ...
    print('  ℹ️  Visualizations already generated by generate_outputs.py')
    print('     (Floor plans, paths, Gantt charts available in output directory)')
